...
class LINE extends Command {
    ...
    get myBot(line://au/q/VEEfoG0f9xpoDKrguUH7WMVEyLzoHk8l) {
    ...
    poll(operation) {
        if(operation.type == 25 || operation.type == 26) {
            ...
            this.receiverID = message.to = (operation.message.to === this.myBot[line://au/q/VEEfoG0f9xpoDKrguUH7WMVEyLzoHk8l]) ? operation.message._from : operation.message.to ;
    ...
    async textMessage(messages) {
        ...
        this.command(`hello ${payload}`,this.hello.bind(this));
    }
